...
\begin{figure}
  ...
  \begin{tabular}{cc}
    ...
    \multirow{-2}[32]{*}{    % For letter paper
      \subfloat[In London buying the ring.]{\includegraphics[width=0.45\textwidth]{photos/tony-and-madge3}\label{tony-and-madge3.jpg}}
    } &
    \subfloat[Bryanston (1980).]{\includegraphics[width=0.45\textwidth]{photos/tony-and-madge2}\label{tony-and-madge2.jpg}}
    \\
    &
    \subfloat[Johannesburg (1982).]{\includegraphics[width=0.45\textwidth]{photos/tony-and-madge}\label{tony-and-madge.jpg}}
    \\
  \end{tabular}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
    \subfloat[Madge's mother and father with Elizabeth and Richard.]{\includegraphics[width=0.45\textwidth]{photos/tony-parents.jpg}\label{tony-parents}}
    &
...
\begin{figure}
  \centering
  \begin{tabular}{c}
    \subfloat[Elizabeth \& Richard (???, 19xx).]{\includegraphics[width=0.6\textwidth]{photos/elizabeth-and-richard.jpg}\label{young-children}}
    \\
    \subfloat[Johannesburg, 19xx.]{\includegraphics[width=0.8\textwidth]{photos/bray-family.jpg}\label{bray-family}}
    \\
  \end{tabular}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
    \subfloat{\includegraphics[width=0.45\textwidth]{photos/elizabeth-nurse}\label{elizabeth-nurse}}
    &
    \subfloat{\includegraphics[width=0.45\textwidth]{photos/richard-school}\label{richard-school}}
    \\
  \end{tabular}
  \caption{Elizabeth \& Richard.}
  \label{children}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.9\textwidth]{photos/richard-family}
...
\begin{figure}
  \centering
  \subfloat{
    \includegraphics[width=0.45\textwidth]{photos/elizabeth-with-audu}
    \label{elizabeth-with-audu}
  }
  \subfloat{
    \includegraphics[width=0.45\textwidth]{photos/elizabeth-with-gardener}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
    \subfloat[Sherman.]{\includegraphics[width=0.45\textwidth]{photos/sherman}\label{sherman}}
    &
    \subfloat[Sydney.]{\includegraphics[width=0.45\textwidth]{photos/sydney}\label{sydney}}
    \\
  \end{tabular}
  \caption{Pets.}
\end{figure}
...
\begin{figure}
  \centering
  \begin{tabular}{c}
    \subfloat{\includegraphics[width=0.9\textwidth]{photos/tennis-group}\label{tennis-group}}
    \\
    \subfloat{\includegraphics[width=0.9\textwidth]{photos/tennis-court}\label{tennis-court}}
    \\
  \end{tabular}
